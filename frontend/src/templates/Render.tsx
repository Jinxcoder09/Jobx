...
const MailIcon = ({ style }: { style?: React.CSSProperties }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" style={{ display: "inline-block", verticalAlign: "middle", ...style }}>
    <rect width="20" height="16" x="2" y="4" rx="2" />
    <path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7" />
  </svg>
);

const PhoneIcon = ({ style }: { style?: React.CSSProperties }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" style={{ display: "inline-block", verticalAlign: "middle", ...style }}>
...
function Header({ data, theme, templateId }: Ctx) {
  ...
  const iconColor = theme.accentColor || theme.primaryColor || "#3b3df1";

  const contactItems = [
    { value: p.email, icon: <MailIcon style={{ width: 11, height: 11, color: iconColor }} /> },
    { value: p.phone, icon: <PhoneIcon style={{ width: 11, height: 11, color: iconColor }} /> },
    { value: p.location, icon: <MapPinIcon style={{ width: 11, height: 11, color: iconColor }} /> },
    { value: p.website, icon: <GlobeIcon style={{ width: 11, height: 11, color: iconColor }} /> },
    { value: p.linkedin, icon: <LinkedinIcon style={{ width: 11, height: 11, color: iconColor }} /> },
    { value: p.github, icon: <GithubIcon style={{ width: 11, height: 11, color: iconColor }} /> },
  ...
  if (templateId === "bold") {
    return (
      <div style={{ marginBottom: theme.sectionSpacing }}>
        ...
        <div style={{ marginTop: 10, fontSize: "0.85em", color: theme.secondaryColor, display: "flex", flexWrap: "wrap", columnGap: 16, rowGap: 6 }}>
  ...
  if (templateId === "executive") {
    return (
      <div style={{ marginBottom: theme.sectionSpacing }}>
        ...
        <div style={{ marginTop: 10, fontSize: "0.82em", color: theme.secondaryColor, display: "flex", flexWrap: "wrap", columnGap: 16, rowGap: 6 }}>
          {contactItems.map((item, idx) => (
            <span key={idx} style={{ display: "inline-flex", alignItems: "center", gap: 5 }}>
              {item.icon}
              {item.value}
  ...
  if (templateId === "modern") {
    return (
      ...
      >
        ...
        <div style={{ marginTop: 8, fontSize: "0.82em", color: theme.secondaryColor, display: "flex", flexWrap: "wrap", columnGap: 16, rowGap: 6 }}>
          {contactItems.map((item, idx) => (
            <span key={idx} style={{ display: "inline-flex", alignItems: "center", gap: 5 }}>
              {item.icon}
              {item.value}
  ...
  if (templateId === "technical") {
    return (
      <div style={{ marginBottom: theme.sectionSpacing, fontFamily: fontStack("JetBrains Mono") }}>
        ...
        <div style={{ marginTop: 8, fontSize: "0.78em", color: theme.secondaryColor, display: "flex", flexWrap: "wrap", columnGap: 14, rowGap: 6 }}>
          {contactItems.map((item, idx) => (
            <span key={idx} style={{ display: "inline-flex", alignItems: "center", gap: 5 }}>
              {item.icon}
              {item.value}
